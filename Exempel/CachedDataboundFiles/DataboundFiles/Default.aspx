<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="DataboundFiles.Default" ViewStateMode="Enabled" %>
...
<body>
    <div id="page">
        ...
        <div id="main">
            ...
            <asp:Button ID="Button1" runat="server" Text="Posta tomt formulär!" />
            <%-- Old School --%>
